...
export declare class ContractProvider extends BaseProvider {
    ...
    deploy(amount: string, maxFee: string, code: Buffer, args?: ContractArgument[]): Promise<string>;
    estimateDeploy(amount: string, maxFee: string, code: Buffer, args?: ContractArgument[]): Promise<JsonReceipt>;
